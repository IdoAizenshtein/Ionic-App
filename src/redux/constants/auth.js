...
export const SET_PUSH_NOTIFICATION_TOKEN = getAsyncActionTypes('SET_PUSH_NOTIFICATION_TOKEN')
export const SEND_PUSH_NOTIFICATION_TOKEN = getAsyncActionTypes('SEND_PUSH_NOTIFICATION_TOKEN')
