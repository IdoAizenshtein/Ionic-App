...
export const GET_ACCOUNT_DATA_AGGREGATE = getAsyncActionTypes('GET_ACCOUNT_DATA_AGGREGATE')
export const GET_ACCOUNT_TODAY_TRANS = getAsyncActionTypes('GET_ACCOUNT_TODAY_TRANS')
export const GET_ACCOUNT_BALANCE_CHART_DATA = getAsyncActionTypes('GET_ACCOUNT_BALANCE_CHART_DATA')
