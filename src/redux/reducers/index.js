...
import { cashFlowAggregatedData, cashFlowBalanceChartData, cashFlowDetailsData } from './cashFlow'
import { checksIncomeData, checksOutData } from './checks'
import { cyclicTransData, cyclicTransRecommendationsData } from './cyclicTrans'
import { banktransForMatchData, cashflowMatchData, getBankMatchAccountData } from './bankMatch'
...
export default {
  ...
  cyclicTransRecommendationsData: recycleState(cyclicTransRecommendationsData, [LOGOUT]),
