...
export default class PackagesScreen extends PureComponent {
          ...
          return (
            <View key={i.toString()}
              ...
              <View
                ...
                {it.active === null && (
                  <Image
                    style={[{ alignSelf: 'center', resizeMode: 'contain', height: 14.5 }]}
                ...
                {it.active === true && (
                  <Image
                    style={[{ alignSelf: 'center', resizeMode: 'contain', height: 14.5 }]}
                    source={require('BiziboxUI/assets/icon-packages-active.png')}
                  />
                )}
              </View>
              <View
  ...
  render () {
    ...
    const thisCompany = (!companies || !companies.length) ? {} : (companies.find(c => c.companyId === currentCompanyId) ? companies.find(c => c.companyId === currentCompanyId) : {})
        ...
        <SafeAreaView style={{
          ...
          <ScrollView
            ...
            <View style={{
              ...
              <Image
                style={[styles.imgIcon, { width: 58 / 2, height: 55 / 2 }]}
        ...
        {showAlert && (
          <Animated.View style={{
            ...
            <View style={{
              ...
              <Image
                style={[{ alignSelf: 'center', resizeMode: 'contain', height: 34, marginTop: -10 }]}
