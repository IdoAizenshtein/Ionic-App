  ...
  get accountTitle () {
    ...
    if (!selectedAccounts.length) {
      return (
        ...
        >
          ...
          <Animated.Text
            style={[styles.bankAccountHeaderText, animateColor]}>{t('bankAccount:selectAccount')}</Animated.Text>
        </TouchableOpacity>
      )
    }
    ...
    if (selectedAccounts.length === 1) {
      return (
        ...
        >
          ...
          <Animated.Text
            style={[styles.bankAccountHeaderText, animateColor]}>{trimTitle(account.accountNickname, currencySign)}</Animated.Text>
        </TouchableOpacity>
      )
    }
    ...
    render () {
      ...
      const headerWrapperTranslate = scrollAnim.interpolate({
        ...
        outputRange: [0, 0, -headerScrollDistance + (isEdit ? headerScrollDistance : 85)],
        extrapolate: 'clamp',
      })
      ...
      return (
        ...
        >
          <View style={[styles.bankAccountHeaderBgWrapper]} pointerEvents='box-none'>
            ...
            {isEdit && (
              <View style={{ elevation: 5, zIndex: 5 }}>
