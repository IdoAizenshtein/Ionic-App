...
export default class Graph extends PureComponent {
    ...
    constructor (props) {
      ...
      if (props.isOpen) {
        ...
        if (data.monthsTotal.length) {
          if (!props.dontSort) {
            data.monthsTotal = data.monthsTotal.sort((a, b) => b.month - a.month).slice(0, 8)
          } else {
          ...
          if (!isAllZero) {
            ...
            data.monthsTotal.forEach((it) => {
              ...
              it.bottom = !showZeroLine ? 0 : it.total < 0 ? (showZeroLine - it.height) : (showZeroLine + (2 / ((max - min) / 100)))
            })
            dataGraph = {
              average: average,
              sumsY: sumsY,
    ...
    componentWillReceiveProps (nextProps) {
      ...
      //
      // }
      // //console.log('--------componentWillReceiveProps---0000--------', nextProps)
