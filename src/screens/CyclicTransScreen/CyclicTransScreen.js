...
export default class CyclicTransScreen extends PureComponent {
  ...
  handleScrollTo = (index) => {
    ...
    //   const offset = parseInt(index * (DATA_ROW_HEIGHT + 1)) + this.headerMinHeightCalc - 20
  ...
  deleteParamNav = () => {
    if (this.props.navigation.state.params.transIdOpened) {
      delete this.props.navigation.state.params.transIdOpened
    }
    if (this.props.navigation.state.params.transIdRemove) {
      delete this.props.navigation.state.params.transIdRemove
    }
    this.setState({
      navigationState: null,
    })
