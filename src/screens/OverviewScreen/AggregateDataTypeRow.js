...
export default class AggregateDataTypeRow extends AnimatedControlledRow {
  ...
  render () {
    ...
    const numberStyle = cs(expenses, [styles.dataValue, { color: colors.green4 }], { color: colors.red2 })
    const isGraph = item.dateTotals.length > 1
    const totalGraph = (isGraph) ? (item.dateTotals[1].total + item.dateTotals[2].total + item.dateTotals[3].total) : null
    const right = [
      {
    ...
    return (
      <Fragment>
        <Swipeout
          ...
          <Animated.View
            style={[styles.dataRowAnimatedWrapper, { height, backgroundColor: item.pressed ? '#ffffff' : '#f3f2f2' }]}>
            <TouchableOpacity
                ...
                <View style={[withinRowStyles, {
                  ...
                  <View style={{
                    ...
                    <Text numberOfLines={1} ellipsizeMode='tail' style={[{
                      ...
                      {translates ? (this.props.searchkey && this.props.searchkey.length > 0 && this.props.searchkey.length > 0 && this.props.searchkey.find((it) => it.paymentDescription === item.description) ? this.props.searchkey.find((it) => it.paymentDescription === item.description).name : '') : item.description}
                    </Text>
                  </View>
                  {item.pressed && (
                    <Fragment>
                          ...
                          <View style={{
                            ...
                            <View
                              style={{
                                ...
                                backgroundColor: (isOpen) ? expenses ? '#e0474d' : '#3a9c68' : '#d0dde4',
                                height: totalGraph ? ((100 * item.dateTotals[1].total / (totalGraph)) * 0.3) : 0,
                                width: 5,
                                position: 'relative',
                              }} />
                            <View
                              style={{
                                marginHorizontal: 1.5,
                                backgroundColor: (isOpen) ? expenses ? '#e0474d' : '#3a9c68' : '#d0dde4',
                                height: totalGraph ? ((100 * item.dateTotals[2].total / (totalGraph)) * 0.3) : 0,
                                width: 5,
                                position: 'relative',
                              }} />
                            <View
                              style={{
                                marginHorizontal: 1.5,
                                backgroundColor: (isOpen) ? expenses ? '#e0474d' : '#3a9c68' : '#d0dde4',
                                height: totalGraph ? ((100 * item.dateTotals[3].total / (totalGraph)) * 0.3) : 0,
                                width: 5,
                                position: 'relative',
                              }} />
                          </View>
                      ...
                      <View
                        ...
                        <View>
                          <Text style={{
                            ...
                            fontSize: sp(13),
                            textAlign: 'center',
                          }}>{getFormattedValueArray(item.dateTotals[1].total)[0]}</Text>
                        </View>
                        <View
                          style={{
                            ...
                            height: totalGraph ? ((100 * item.dateTotals[1].total / (totalGraph)) * 1.1) : 0,
                            width: 23,
                            alignSelf: 'center',
                            position: 'relative',
                          }} />
                        <View>
                          <Text style={{
                            ...
                            fontSize: sp(13),
                            textAlign: 'center',
                          }}>{AppTimezone.moment(item.dateTotals[1].date).format('MM/YYYY')}</Text>
                        </View>
                      </View>
                      <View style={{
                        flexDirection: 'column',
                        ...
                        <View>
                          <Text style={{
                            ...
                            fontSize: sp(13),
                            textAlign: 'center',
                          }}>{getFormattedValueArray(item.dateTotals[2].total)[0]}</Text>
                        </View>
                        <View
                          style={{
                            borderTopRightRadius: 3,
                            ...
                            backgroundColor: expenses ? '#e0474d' : '#3a9c68',
                            zIndex: 1,
                            height: totalGraph ? ((100 * item.dateTotals[2].total / (totalGraph)) * 1.1) : 0,
                            width: 23,
                            alignSelf: 'center',
                            position: 'relative',
                          }} />
                        <View>
                          <Text style={{
                            ...
                            fontSize: sp(13),
                            textAlign: 'center',
                          }}>{AppTimezone.moment(item.dateTotals[2].date).format('MM/YYYY')}</Text>
                        </View>
                      </View>
                      <View style={{
                        flexDirection: 'column',
                        ...
                        <View>
                          <Text style={{
                            ...
                            fontSize: sp(13),
                            textAlign: 'center',
                          }}>{getFormattedValueArray(item.dateTotals[3].total)[0]}</Text>
                        </View>
                        <View
                          style={{
                            borderTopRightRadius: 3,
                            borderTopLeftRadius: 3,
                            backgroundColor: expenses ? '#e0474d' : '#3a9c68',
                            height: totalGraph ? ((100 * item.dateTotals[3].total / (totalGraph)) * 1.1) : 0,
                            width: 23,
                            alignSelf: 'center',
                            position: 'relative',
                          }} />
                        <View>
                          <Text style={{
                            ...
                            fontSize: sp(13),
                            textAlign: 'center',
                          }}>{AppTimezone.moment(item.dateTotals[3].date).format('MM/YYYY')}</Text>
                        </View>
                      </View>
                    </View>
                  </View>
