...
import { combineStyles as cs, getTransCategoryIcon, sp } from '../../../utils/func'
...
import { accountCflCheckDetailsApi, accountCflDataUpdateApi, updateCheckRowApi } from '../../../api'
          ...
          <View style={[{
            ...
            <View style={[withinRowStyles, {
              ...
              <View style={{
                ...
                <Text
                  ...
                  {'מספר צ\'ק:'} {item.chequeNo && item.chequeNo.toString().length > 7 ? renderTextYellow(item.chequeNo.toString().substring(0, 7) + '..') : renderTextYellow(item.chequeNo)}
                </Text>
              </View>
              <View style={{
                flex: 10,
            ...
            <View style={[withinRowStyles, {
              ...
              {item.targetType !== 'BANK_TRANS' && (
                <TouchableOpacity
                  ...
                  <View style={styles.categoryEditBtnWrapper}>
                    <Image style={{ width: 18.5, height: 16.5 }}
                      source={require('BiziboxUI/assets/commentIcon.png')} />
                  </View>
                </TouchableOpacity>
              )}
              <View style={commonStyles.spaceDividerDouble} />
              <EditableTextInput
                ...
                textStyle={cs(isOpen, [styles.dataValue, commonStyles.regularFont, {
                  fontSize: sp(16),
                  color: colors.blue7,
                  fontFamily: fonts.regular,
                  direction: 'ltr',
                ...
                value={(isEdit || !chequeComment.length) ? chequeComment : renderTextYellow(chequeComment)}
