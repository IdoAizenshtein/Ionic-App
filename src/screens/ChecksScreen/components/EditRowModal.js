...
export default class EditRowModal extends PureComponent {
  ...
  constructor (props) {
    ...
    this.state = {
      ...
      obj: {
        ...
        chequeNo: (item.chequeNo !== undefined && item.chequeNo !== null) ? String(item.chequeNo) : '',
  ...
  existingCheck = (text) => {
    ...
    if (this.state.obj.companyAccountId &&
      ((text && text.length) || (valuesSave.biziboxMutavId) || (Number(valuesSave.total) !== 0 && valuesSave.dueDate))
  ...
  editInput = (param) => () => {
    if (param === 'companyAccountId') {
      ...
      const isEditableDueDate = !this.state.disabledEdit.dueDate && this.state.obj.targetType !== 'BANK_CHEQUE' && AppTimezone.moment(this.state.obj.dueDate).isSameOrAfter(AppTimezone.moment().valueOf())
  ...
  render () {
    ...
    const numberStyle = cs(!screenSwitchState, [styles.dataValue, { color: colors.green4 }], { color: colors.red2 })
    const rowStyle = !isRtl ? 'row-reverse' : 'row'
    const isEditableDueDate = !this.state.disabledEdit.dueDate && obj.targetType !== 'BANK_CHEQUE' && AppTimezone.moment(obj.dueDate).isSameOrAfter(AppTimezone.moment().valueOf())

    let isCheckExistText = ''
    if (this.state.obj.asmachtaExist) {
      const dueDate = AppTimezone.moment(this.state.obj.asmachtaExist.dueDate).format('DD/MM/YY') === AppTimezone.moment().format('DD/MM/YY')
        ? 'היום'
        : AppTimezone.moment(this.state.obj.asmachtaExist.dueDate).format('DD/MM/YY')
      const totals = String(getFormattedValueArray(this.state.obj.asmachtaExist.total)[0]).includes('-') ? (String(getFormattedValueArray(this.state.obj.asmachtaExist.total)[0]).replace('-', '') + '-') : getFormattedValueArray(this.state.obj.asmachtaExist.total)[0]
                ...
                <View style={{
                  ...
                  <KeyboardAwareScrollView>
                    ...
                    {this.state.typeEditModal === 'dueDate' && (<View style={{
                      ...
                      <Calendar
                        current={AppTimezone.moment(this.state.obj.dueDate).format('YYYY-MM-DD')}
                        markedDates={{
                          [AppTimezone.moment(this.state.obj.dueDate).format('YYYY-MM-DD')]: {
                            startingDay: true,
                            selected: true,
                            color: colors.blue3,
                          },
              ...
              <View style={{
                ...
                <KeyboardAwareScrollView>
                  <View style={[cs(!isRtl, commonStyles.row, [commonStyles.rowReverse]), {
                    height: 42,
                    marginBottom: 8,
                  }, cs(this.state.disabledEdit.companyAccountId, { opacity: 1 }, { opacity: 0.3 })]}>
                  ...
                  <View
                    style={[cs(!isRtl, commonStyles.row, [commonStyles.rowReverse]), {
                      height: 42,
                      marginBottom: 8,
                    }, cs(this.state.disabledEdit.userDescription, { opacity: 1 }, { opacity: 0.3 })]}>
                    <View style={{ flex: 1.76, alignItems: 'flex-end' }}>
                      <Text style={{
                        color: '#0f3860',
                        fontSize: sp(13),
                  ...
                  <View
                    style={[cs(!isRtl, commonStyles.row, [commonStyles.rowReverse]), {
                      height: 42,
                      marginBottom: 8,
                    }, cs(this.state.disabledEdit.transTypeId, { opacity: 1 }, { opacity: 0.3 })]}>
                    <View style={{ flex: 1.76, alignItems: 'flex-end' }}>
                      <Text style={{
                        color: '#0f3860',
                        fontSize: sp(13),
                  ...
                  <View
                    style={[cs(!isRtl, commonStyles.row, [commonStyles.rowReverse]), {
                      height: 42,
                      marginBottom: 8,
                    }, cs(this.state.disabledEdit.chequeNo, { opacity: 1 }, { opacity: 0.3 })]}>
                    <View style={{ flex: 1.76, alignItems: 'flex-end' }}>
                      <Text style={{
                        color: '#0f3860',
                        fontSize: sp(13),
                    ...
                    <View style={{
                      ...
                      <TextInput
                        ...
                        onEndEditing={(e) => this.existingCheck(e.nativeEvent.text)}
                  ...
                  <View
                    style={[cs(!isRtl, commonStyles.row, [commonStyles.rowReverse]), {
                      height: 42,
                      marginBottom: 8,
                    }, cs((isEditableDueDate), { opacity: 0.3 }, { opacity: 1 })]}>
                    <View style={{ flex: 1.76, alignItems: 'flex-end' }}>
                      <Text style={{
                        color: '#0f3860',
                        fontSize: sp(13),
                    ...
                    <View style={{
                      ...
                      <TouchableOpacity
                        ...
                        <Text style={[{
                          ...
                          fontSize: sp(15),
                          lineHeight: 42,
                        }, commonStyles.regularFont]}>{AppTimezone.moment(this.state.obj.dueDate).format('DD/MM/YY')}</Text>
                      </TouchableOpacity>
                    </View>
                  </View>
                  ...
                  <View
                    style={[cs(!isRtl, commonStyles.row, [commonStyles.rowReverse]), {
                      height: 42,
                      marginBottom: 8,
                    }, cs(this.state.disabledEdit.total, { opacity: 1 }, { opacity: 0.3 })]}>
                    <View style={{ flex: 1.76, alignItems: 'flex-end' }}>
                      <Text style={{
                        color: '#0f3860',
                        fontSize: sp(13),
                    ...
                    <View style={[{
                      ...
                      {this.state.editSum && (
                        <TextInput
                          autoCorrect={false}
                          autoFocus
                          editable={!this.state.disabledEdit.total && this.state.editSum}
                          ...
                          value={this.state.obj.total !== null ? String(this.state.obj.total) : ''}
                          underlineColorAndroid='transparent'
                        />
                      )}
