...
export default class SlikaAdditionalInfo extends PureComponent {
    ...
    render () {
      ...
      const rowStyles = cs(isRtl, [styles.dataRowWrapper, styles.dataRowLevel3], commonStyles.rowReverse)
        ...
        <View style={styles.dataRowLevel3Wrapper}>
          ...
          <View style={rowStyles}>
            ...
            <Text style={styles.dataRowLevel3Text} numberOfLines={1}>
              <Text
                style={[styles.dataValueText, regularPayments < 0 ? styles.dataValueNegativeText : styles.dataValuePositiveText]}
                numberOfLines={1}
              >
                {regularPayments[0]}
              </Text>
              <Text style={styles.fractionalPart} numberOfLines={1}> .{regularPayments[1]} </Text>
            </Text>
          </View>
          ...
          <View style={rowStyles}>
            ...
            <Text style={styles.dataRowLevel3Text} numberOfLines={1}>
              <Text
                style={[styles.dataValueText, paymentsTotal < 0 ? styles.dataValueNegativeText : styles.dataValuePositiveText]}
                numberOfLines={1}
              >
                {paymentsTotal[0]}
              </Text>
              <Text style={styles.fractionalPart} numberOfLines={1}> .{paymentsTotal[1]} </Text>
            </Text>
          </View>
          ...
          {(!IS_LIGHT.light && data.expectedPercent !== null) && (
            <View style={rowStyles}>
              ...
              <Text
                style={[styles.dataValueText, data.expectedPercent < 0 ? styles.dataValueNegativeText : styles.dataValuePositiveText]}
              >
