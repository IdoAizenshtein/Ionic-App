...
export default class SlikaDetailsRow extends AnimatedRow {
  ...
  render () {
    ...
    const wrapperStyles = cs(
      isRtl,
      cs(isOpen, [styles.dataRowWrapper, styles.dataRowLevel2], styles.dataRowLevel2Active),
            ...
            <View style={cs(isRtl, styles.dataValueWrapperLevel2)}>
              <View style={cs(isRtl, commonStyles.row, commonStyles.rowReverse)}>
                <Text style={styles.dataRowValueTextLevel2} numberOfLines={1}>
                  <Text
                    style={[styles.dataValueText, data.transTotal < 0 ? styles.dataValueNegativeText : styles.dataValuePositiveText]}
                    numberOfLines={1}
                  >
                    {total[0]}
                  </Text>
                  <Text style={styles.fractionalPart} numberOfLines={1}> .{total[1]} </Text>
                </Text>
              </View>
            </View>
          </View>
