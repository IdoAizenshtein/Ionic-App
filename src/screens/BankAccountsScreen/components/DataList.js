...
import { Animated, Dimensions, RefreshControl, ScrollView, SectionList, Text, View } from 'react-native'
...
export default class DataList extends PureComponent {
  ...
  componentWillReceiveProps ({ screenSwitchState, currentSelectedAccountId, currentOpenItemIndex }) {
