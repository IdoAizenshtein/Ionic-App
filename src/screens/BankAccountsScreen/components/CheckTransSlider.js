...
export default class CheckTransSlider extends PureComponent {
  ...
  renderItem = ({ item, index }) => {
    ...
    const data = details || []
    const isShadowCard = (bankTrans.pictureLink || (!bankTrans.pictureLink && data.length > 1))
    return (
      <View
        style={[isShadowCard ? styles.sliderItemGradient : styles.sliderItemGradientNotCard, { paddingVertical: bankTrans.pictureLink ? 2 : 10 }]}
      >
        {item
          ? (bankTrans.pictureLink ? this.blockWithImg(item, index) : this.simpleBlock(item, index))
          : (<Text>Not found</Text>)}
      </View>
    )
  }
  ...
  simpleBlock = (item, index) => {
    ...
    const total = getFormattedValueArray(item.transfertotal)
    const numberStyle = bankTrans ? cs(bankTrans.hova, [{
      ...
      return (
        <Fragment>
          <View style={{
            ...
            <Text style={styles.panelTitle}>{item.namepayertransfer}</Text>
          ...
          <View style={{
            ...
            <View style={{
              ...
              <View>
                <Text style={{
                  ...
                  textAlign: 'center',
                }}>{item.accounttransfernumber}</Text>
                <Text style={{
                  color: '#022258',
                  fontSize: sp(16),
                  fontFamily: fonts.regular,
            ...
            <View style={{
              ...
              <Text style={{
                ...
                fontFamily: fonts.regular,
                textAlign: 'center',
              }}>{item.branchtransfernumber}</Text>
              <Text style={{
                color: '#022258',
                fontSize: sp(16),
                fontFamily: fonts.regular,
            ...
            {bankTrans.linkId && bankTrans.linkId !== '00000000-0000-0000-0000-000000000000' && (
              <TouchableOpacity
                ...
                onPress={isEnabled ? handleOpenCategoriesModal(item, index, bankTrans) : null}>
                ...
                <View>
                  <View style={{
                    ...
                    {categories.find((cat) => cat.transTypeId === item.transTypeId) && (
                      <CustomIcon
                        name={getTransCategoryIcon(categories.find((cat) => cat.transTypeId === item.transTypeId).iconType)}
                        size={18}
                        color={colors.blue7}
                      />
                    )}
                  ...
                  <Text style={{
                    ...
                    fontFamily: fonts.regular,
                    textAlign: 'center',
                  }}>{categories.find((cat) => cat.transTypeId === item.transTypeId) ? categories.find((cat) => cat.transTypeId === item.transTypeId).transTypeName : ''}</Text>
          ...
          {item.detailstransfer && (
            <View style={{
              ...
              <View style={{
                ...
                <Image style={{ width: 20, height: 21.5 }}
        ...
        <Fragment>
          ...
          <View style={{
            ...
            <View style={{
              ...
              <Image style={{ alignSelf: 'center', resizeMode: 'contain', width: 19, height: 19 }}
          ...
          {item.detailstransfer && (<View style={{
            flexDirection: 'row-reverse',
            marginVertical: 15,
            alignItems: 'center',
            alignContent: 'center',
      ...
      <Fragment>
        ...
        <View style={{
          ...
          {item.image ? (
            <TouchableOpacity
              ...
              onPress={this.handleShowImgPreview(`data:image/jpg;base64,${item.image}`)}
            >
              <Image
          ...
          ) : <Text style={styles.noImageText}>{t('bankAccount:noScanFound')}</Text>}
        </View>
        ...
        <View style={{
          ...
          <TouchableOpacity
            ...
            onPress={isEnabled ? handleOpenCategoriesModal(item, index, bankTrans, true) : null}>
  ...
  render () {
    ...
    return (
      <View>
        {inProgress ? (
          <View
            style={[isShadowCard ? styles.sliderItemGradient : styles.sliderItemGradientNotCard, { width: slideWidth }]}
          >
            <Loader
              isDefault
