...
export default class BankAccountsScreen extends PureComponent {
  constructor (props) {
    ...
    this.state = {
      ...
      bankTransIdOpened: this.props.navigation.getParam('bankTransId') ? this.props.navigation.state.params.bankTransId : null,
      idxCategory: 0,
      enabledScrolls: true,
      bounces: true,
      screenHeight: 0,
  ...
  getScreenData = (isLoader = true, isSwitchAccount = false) => {
    ...
    if (isLoader) this.setState({ inProgress: true })
    ...
    if (isToday) tasks.push(this.getTodayTransData())
        ...
        if (this.props.navigation.state.params.filterText) {
          if (!this.screenSwitchState) {
            ...
            bankTransCopy.forEach((section, idx) => {
              section.data = section.data.filter(a => a.mainDesc.includes(this.props.navigation.state.params.filterText))
      ...
      if (this.state.bankTransIdOpened) {
        setTimeout(() => {
          ...
          if (lastRowOpened) {
            ...
            if (lastRow) {
              if (!this.props.navigation.getParam('bankTransId')) {
          ...
          if (this.props.navigation.getParam('bankTransId')) {
            delete this.props.navigation.state.params.bankTransId
          }
        }, this.props.navigation.getParam('bankTransId') ? 600 : 0)
      }
    }, 100)
  }
  ...
  render () {
    ...
    const disabledEdit =
      ((dataRow && dataRow.paymentDesc === 'Checks' && dataRow.pictureLink && dataRow.pictureLink !== '00000000-0000-0000-0000-000000000000' && dataRow.pictureLink !== null) || (dataRow && dataRow.cashCat === true))
        ? true
        : (dataRow ? ((dataRow.isToday) || (dataRow.paymentDesc === 'BankTransfer' && dataRow.linkId !== '00000000-0000-0000-0000-000000000000')) : null)
