      ...
      >
        ...
        >
          ...
          <Text style={styles.confirmRemoveTitle1}>
            {t('settings:slikaTab:deleteSlikaName', { tokenName: item.solekDesc.replace(/"/g, '') })}
          </Text>

          <Text style={styles.confirmRemoveDesc1}>{t('settings:slikaTab:deleteSlikaDesc')}</Text>
          ...
          <TouchableOpacity onPress={onSubmit}>
            <Text style={tabStyles.modalLinkText}>{t('settings:slikaTab:deleteSlika')}</Text>
          </TouchableOpacity>
        </ScrollView>
      </Modal>
    )
