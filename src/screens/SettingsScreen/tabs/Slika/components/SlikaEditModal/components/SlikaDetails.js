          ...
          >
            <View style={styles.detailsRow}>
              ...
              <View style={styles.detailsRightPart}>
                <Text style={styles.detailsRightText}>{t('settings:slikaTab:editSlika')}</Text>
              </View>
            </View>
            <View style={styles.detailsRow}>
                ...
                <View style={{
                  ...
                  >
                    ...
                    <Text style={styles.confirmRemoveTitle1}>
                      {t('settings:slikaTab:changeSlikaAcc', { name: account.accountNickname.replace(/"/g, '') })}
                    </Text>

                    <Text
                      style={styles.confirmRemoveDesc1}>{t('settings:slikaTab:changeSlikaAccDesc')}</Text>
