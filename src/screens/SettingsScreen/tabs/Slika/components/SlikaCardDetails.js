        ...
        <View style={styles.accountDetailsWrapper}>
          <View style={styles.accountDetailsFirstRow}>
            {isDeleted
              ? (
                <TouchableOpacity onPress={this.handleOpenRecoveryModal}>
                  <Text
                    style={styles.accountLinkText}>{t(`settings:bankAccountsTab:solekRecovery`)}</Text>
                </TouchableOpacity>
              )
              : (
            ...
            <View style={{
              ...
              <Text
                style={[cs(isDeleted, styles.accountTitleText, styles.accountPaleText), commonStyles.semiBoldFont, {
                  // maxWidth: 140,
                }]}
                ellipsizeMode='tail'
                numberOfLines={1}
          ...
          <View>
            <Text
              ...
              {account.accountNickname} {t('settings:slikaTab:accountNumber')} {account.bankAccountId}
            </Text>
