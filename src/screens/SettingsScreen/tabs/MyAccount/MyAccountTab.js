...
export default class MyAccountTab extends PureComponent {
  ...
  get currentCompany () {
    ...
    handleUpdateUser = () => {
      ...
      if (inProgress || !(
        String(userSettings.firstName).length > 0 && String(userSettings.lastName).length > 0
      )) {
        return
      }
    ...
    handleChangePassword = () => {
      ...
      if (username === password || !oldPassword || oldPassword.length === 0 || !password || password !== confirmPassword || inProgress || password.length < 8 || password.length >= 12 || password.replace(/[^\d]/g, '').length === 0 || password.replace(/[^A-Za-z]/g, '').length === 0) return
      Keyboard.dismiss()
      this.setState({ inProgress: true, errPass: false })
    ...
    handleTurnTwoPhaseForUse = () => {
      ...
      if (!code || code.length === 0 || inProgress) return
      Keyboard.dismiss()
      this.setState({ inProgress: true, errTurn: false, codeValid: true })

      const turnTwoPhaseForUse = userSettings.authenticationType === 'REGULAR' ? turnOnTwoPhaseForUseApi : turnOffTwoPhaseForUserApi
      turnTwoPhaseForUse.post({
        ...
        .then(() => {
          this.setState({ inProgress: false, errTurn: false, codeValid: true, successTurnTwoPhaseForUse: true })
        ...
        .catch(() => {
          this.setState({ inProgress: false, errTurn: true, codeValid: false })
        })
    };
        ...
        <SafeAreaView style={[{
          ...
          {successTurnTwoPhaseForUse && (
            <View style={{
              ...
              }}>{'כניסה מחמירה '} {userSettings.authenticationType !== 'REGULAR' ? 'הופעלה' : 'בוטלה'}
              </Text>
            </View>
          )}
            ...
            <View style={{
              ...
              <View
                ...
                <View style={[{
                  ...
                  borderWidth: (userSettings && String(userSettings.firstName).length > 0) ? 0 : 1,
                }]}>
                  <TextInput
                    editable
              ...
              <View
                ...
                <View style={[{
                  ...
                  borderBottomRightRadius: 20,
                  borderTopRightRadius: 20,
                  borderWidth: (userSettings && String(userSettings.lastName).length > 0) ? 0 : 1,
                  borderColor: colors.red,
                }]}>
                  <TextInput
                    editable
              ...
              <View style={{
                ...
                <View style={{
                  ...
                  <Text style={{
                    ...
                    textAlign: 'right',
                    fontFamily: fonts.regular,
                  }}>{(userSettings.language && userSettings.language === 'HEB') ? 'עברית' : userSettings.language}</Text>
                </View>
              </View>
              <View style={{
                flexDirection: 'row-reverse',
              ...
              <View style={{
                ...
                }}>{userSettings.authenticationType === 'REGULAR' ? 'רגילה' : 'מחמירה'}</Text>
              </View>
              ...
              <TouchableOpacity
                ...
                <Image
                  ...
                  source={require('BiziboxUI/assets/iconAuthenticationType.png')} />
                <Text style={{
                  color: '#ffffff',
                  fontSize: sp(16),
                  textAlign: 'right',
                  fontFamily: fonts.semiBold,
                }}>{userSettings.authenticationType === 'REGULAR' ? 'הפעל ' : 'ביטול '}{'כניסה מחמירה'}</Text>
              </TouchableOpacity>
                  ...
                  <Fragment>
                    <View
                      ...
                      <View style={[{
                        ...
                        borderBottomRightRadius: 20,
                        borderTopRightRadius: 20,
                        borderWidth: (emailExists || !mailValid || errPass) ? 1 : 0,
                        borderColor: colors.red,
                      }]}>
                        <TextInput
                    ...
                    <View
                      style={[cs(isRtl, commonStyles.row, [commonStyles.rowReverse]), {
                        marginBottom: (emailExists || !mailValid || mailIsHebrew) ? 8 : 0,
                      }]}>
                      <View style={{ flex: 1.95 }} />
                      <View style={[{
                        flex: 5.73,
              ...
              <KeyboardAwareScrollView
                ...
                <View
                  ...
                  <View style={[{
                    ...
                    <TextInput
                      ...
                      onEndEditing={(e) => {
                        this.setState({
                          oldPassword: e.nativeEvent.text.toString().replace(getEmoji(), '').replace(/\s+/g, ''),
                        })
                ...
                <View
                  ...
                  <View style={[{
                    ...
                    borderTopRightRadius: 20,
                    borderColor: colors.red,
                    borderWidth: ((!passwordValid) || (password.length > 0 && confirmPassword.length > 0 && password !== confirmPassword)) ? 1 : 0,
                  }]}>
                    <TextInput
                      underlineColorAndroid='transparent'
                      secureTextEntry={!secureTextEntry}
                ...
                <View
                  ...
                  <View style={[{
                    ...
                    borderTopRightRadius: 20,
                    borderColor: colors.red,
                    borderWidth: (password.length > 0 && confirmPassword.length > 0 && password !== confirmPassword) ? 1 : 0,
                  }]}>
                    <TextInput
                      underlineColorAndroid='transparent'
                ...
                <Button
                  disabled={(username === password || !oldPassword || oldPassword.length === 0 || !password || password !== confirmPassword || inProgress || password.length < 8 || password.length >= 12 || password.replace(/[^\d]/g, '').length === 0 || password.replace(/[^A-Za-z]/g, '').length === 0)}
                  buttonStyle={[{
                    marginTop: 25,
                    height: 45,
                    borderRadius: 6,
                ...
                <View style={cs(
                  ...
                  <View style={{ alignItems: 'center' }}>
                    <Text style={{ fontSize: sp(20), color: '#ffffff', fontFamily: fonts.semiBold }}>
                      {userSettings.authenticationType === 'REGULAR' ? 'הפעל ' : 'ביטול '}{'כניסה מחמירה'}
                    </Text>
                  </View>
                  <View>
                    <TouchableOpacity
                ...
                {(authenticationTypeStep === 2) && (
                  <View style={{
                    ...
                    <Text style={[{
                      ...
                      {userSettings.authenticationType === 'REGULAR' ? 'להפעלה ' : 'לביטול '} {'הזינו את הקוד שנשלח לנייד '}{smsInfo.maskedPhoneNumber}
                    </Text>
                    ...
                    <View
                      ...
                      <View style={[{
                        ...
                        <TextInput
                          ...
                          onEndEditing={(e) => {
                            this.setState({
                              code: e.nativeEvent.text.toString().replace(getEmoji(), '').replace(/\s+/g, ''),
                            })
                          }}
                    ...
                    <Button
                      ...
                      title={(userSettings.authenticationType === 'REGULAR' ? 'הפעלת ' : 'ביטול ') + ' כניסה מחמירה'}
                    />
                  </View>
                )}
              </KeyboardAwareScrollView>
