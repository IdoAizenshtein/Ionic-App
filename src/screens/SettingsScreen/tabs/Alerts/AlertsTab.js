        ...
        <ScrollView
          ...
          <View style={{
            ...
            <View style={{
              ...
              <CustomIcon name='exclamation-triangle' size={16} color={colors.red2} style={{
                marginHorizontal: 10,
              }} />
              <Text style={{
                color: '#022157',
            ...
            <TouchableOpacity onPress={this.openModalPushTimeToSend} style={{
              ...
              }}>{`${hour === '10' ? hour : '0' + hour}:${min === '0' ? '00' : '30'}`}</Text>
            </TouchableOpacity>
          </View>
                    ...
                    {messageShow.messages.map((item, i) => (
                      <View key={item.messageTypeId}
                        ...
                        <Text style={{
                          ...
                          flex: 80,
                          fontFamily: fonts.regular,
                        }}>{item.messageTypeName ? item.messageTypeName.trim() : ''}</Text>
