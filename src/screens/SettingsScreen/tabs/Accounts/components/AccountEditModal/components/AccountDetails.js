      ...
      >
        ...
        <View style={styles.detailsRow}>
          ...
          <View style={styles.detailsRightPart}>
            <Text style={styles.detailsRightText}>{t('settings:bankAccountsTab:editAccountName')}</Text>
          </View>
        </View>
        ...
        <View style={styles.detailsRow}>
          ...
          <View style={styles.detailsRightPart}>
            <Text style={styles.detailsRightText}>{t('settings:bankAccountsTab:selectUsers')}</Text>
          </View>
        </View>
        ...
        <View style={styles.detailsRow}>
          <TouchableOpacity onPress={onTogglePrimaryAccount} style={{
            ...
            {isPrimaryAccount
              ? <Image style={[styles.primaryAccountIcon, { alignSelf: 'flex-end' }]}
          ...
          <View style={styles.detailsRightPart}>
            <Text
              style={styles.detailsRightText}>{t('settings:bankAccountsTab:selectLeadingAccount')}</Text>
          </View>
        </View>
