      ...
      >
        ...
        >
          ...
          <Text style={styles.confirmRemoveTitle1}>
            {t('settings:bankAccountsTab:deleteAccountName', { tokenName: account.accountNickname })}
          </Text>

          <Text style={styles.confirmRemoveDesc1}>{t('settings:bankAccountsTab:deleteAccountDesc')}</Text>
          ...
          <TouchableOpacity onPress={onSubmit}>
            <Text style={tabStyles.modalLinkText}>{t('settings:bankAccountsTab:deletingAccount')}</Text>
          </TouchableOpacity>
        </ScrollView>
      </Modal>
    )
