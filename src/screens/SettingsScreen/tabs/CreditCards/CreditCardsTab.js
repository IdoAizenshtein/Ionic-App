...
import CreditCardEditModal from './components/CreditCardEditModal/CreditCardEditModal'
...
export default class CreditCardsTab extends PureComponent {
    ...
    getDeletedCreditCards = (tokenIds) => {
      ...
      return getDeletedCreditCardsApi.post({ body: { companyId, tokens: tokenIds } })
    };
    ...
    handleUpdateCreditLimit = (creditLimit) => {
      ...
      this.setState({ setCreditLimitInProgress: true, isUpdate: false })
    ...
    render () {
      const { t, currentCompany, navigation, paramsLinkAddCard, closeParent, isRtl, exampleCompany } = this.props
