      ...
      >
        ...
        >
          ...
          <Text style={styles.confirmRemoveTitle1}>
            {t('settings:bankAccountsTab:deleteCardtName', { tokenName: item.creditCardNickname })}
          </Text>

          <Text style={styles.confirmRemoveDesc1}>{t('settings:creditCardsTab:deleteAccountDesc')}</Text>
          ...
          <TouchableOpacity onPress={onSubmit}>
            <Text style={tabStyles.modalLinkText}>{t('settings:creditCardsTab:deleteCard')}</Text>
          </TouchableOpacity>
        </ScrollView>
      </Modal>
    )
