            ...
            {!banktransForMatchData && (
              <Animated.View
                ...
                <Text style={[{
                  ...
                  fontFamily: fonts.regular,
                  fontSize: sp(18),
                  lineHeight: item.hovAvar && AppTimezone.moment(item.targetOriginalDate).isBefore(AppTimezone.moment()) ? 17 : 20,
                  marginBottom: item.hovAvar && AppTimezone.moment(item.targetOriginalDate).isBefore(AppTimezone.moment()) ? 0 : 2,
                  color: '#ffffff',
                ...
                <View
                  ...
                  <Text style={[{
                    lineHeight: item.hovAvar && AppTimezone.moment(item.targetOriginalDate).isBefore(AppTimezone.moment()) ? 13 : 14,
                    fontSize: sp(14),
                    fontFamily: fonts.regular,
                    color: '#ffffff',
                  }]}>
