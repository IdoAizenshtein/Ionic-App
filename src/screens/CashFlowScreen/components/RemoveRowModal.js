...
import { Card } from '../../BankMatchScreen/components/Card'
...
export default class RemoveRowModal extends PureComponent {
    ...
    render () {
      ...
      const targetName = item.transName
            ...
            <View style={{
              ...
              <View style={{
                ...
                <View style={cs(
                  ...
                  <View>
                    {!Card.showIconRef(item.targetType) && (
              ...
              {Card.showIconRef(item.targetType) && (
                <View style={{
                  ...
                  <TouchableOpacity
                    ...
                    <Text
                      style={[styles.btnMatch, { fontFamily: fonts.semiBold }]}>{'תנועה זו בלבד'}</Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    style={[{
                      height: 45,
                    ...
                    <Text
                      style={[styles.btnMatch, { fontFamily: fonts.semiBold }]}>{'התנועה הקבועה כולה'}</Text>
                  </TouchableOpacity>
                </View>
              )}
            </View>
