          ...
          <View style={[withinRowStyles, {
            ...
            <View style={{
              ...
              {cashFlowDetailsDataItem.targetType !== 'BANK_TRANS' && (
                <TouchableOpacity
                  onPress={cashFlowDetailsDataItem.targetType === 'SOLEK_TAZRIM' ? this.getUnionDet : this.handlePopRowEditsModal(cashFlowDetailsDataItem)}>
              ...
              <View style={[withinRowStyles, {
                ...
                <View style={{
                  ...
                  <TouchableOpacity
                    ...
                    onPress={cashFlowDetailsDataItem.unionId ? this.getUnionDet : null}
                  >
                    {this.showIconRef(cashFlowDetailsDataItem.targetType) && (<View>
                      <Icon
                        iconStyle={{
                          transform: [{ scaleX: -1 }],
                          marginHorizontal: 2,
                    ...
                    <Text numberOfLines={1}
                      ...
                      style={[{
                        fontSize: sp(16),
                        color: !cashFlowDetailsDataItem.unionId ? colors.blue8 : '#038ed6',
                        fontFamily: fonts.regular,
                      ...
                      {(this.props.searchkey && this.props.searchkey.length > 0 && this.props.searchkey.find((it) => it.paymentDescription === cashFlowDetailsDataItem.paymentDesc) ? this.props.searchkey.find((it) => it.paymentDescription === cashFlowDetailsDataItem.paymentDesc).name : '')}
                    </Text>
                  </TouchableOpacity>
                </View>
              </View>
              <View style={[withinRowStyles, {
                ...
                <View style={{
                  ...
                  <Text style={{
                    ...
                    {t('bankAccount:reference')} {renderTextYellow(cashFlowDetailsDataItem.asmachta)}
                  </Text>
                </View>
                <View style={{
                  flex: 7,
                ...
                <View style={{
                  ...
                  <TouchableOpacity
                    onPress={cashFlowDetailsDataItem.targetType === 'BANK_TRANS' ? onEditCategory(transType) : null}
                    activeOpacity={(cashFlowDetailsDataItem.targetType !== 'BANK_TRANS') ? 1 : 0.2}
                    style={cs(isRtl, commonStyles.row, [commonStyles.rowReverse], {
                      flex: 1,
                      flexDirection: 'row',
                      justifyContent: 'flex-end',
                    ...
                    <View>
                      <CustomIcon
                        name={transType ? getTransCategoryIcon(transType.iconType) : null}
                        size={18}
                        color={colors.blue7}
                      />
                    </View>
                    ...
                    <Text numberOfLines={1}
                      ...
                      style={{
                        ...
                        color: colors.blue7,
                        fontFamily: fonts.regular,
                      }}>{(transType && transType.transTypeName) ? transType.transTypeName : ''}</Text>
                  </TouchableOpacity>
            ...
            <View style={{
              ...
              <TouchableOpacity
                onPress={cashFlowDetailsDataItem.targetType === 'SOLEK_TAZRIM' ? this.getUnionDet : this.removeItem(cashFlowDetailsDataItem, true)}>
                <View style={styles.categoryEditBtnWrapper}>
                  <CustomIcon
                    name='trash'
                    size={18}
                        ...
                        <View key={i.toString()}>
                          <View
                            ...
                            <View style={{
                              ...
                              <TouchableOpacity onPress={this.handlePopRowEditsModal(c)}>
                                <View style={{
                                  marginRight: 'auto',
                                }}>
                                  <Icon name='chevron-left' size={30} color={'#022258'} />
                                </View>
                              </TouchableOpacity>
                            </View>
                            <View style={{
