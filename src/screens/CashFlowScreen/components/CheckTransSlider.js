        ...
        <Fragment>
          ...
          <TouchableOpacity
            ...
            <View style={{
              ...
              <Text
                style={styles.dataRowLevel3Text}>{categories.find((cat) => cat.transTypeId === item.transTypeId) ? categories.find((cat) => cat.transTypeId === item.transTypeId).transTypeName : ''}</Text>
            </View>
