...
// import {ALERTS_TRIAL, COMPANY_INFO} from '../../constants/config'
    ...
    setTimeout(() => {
      ...
      if (company.budgetPopUpType !== null && company.budgetPopUpType !== 0) {
        if (company.budgetPopUpType === 1) {
          ...
          this.openBottomSheet()
        } else if (company.budgetPopUpType === 2 || company.budgetPopUpType === 3) {
          if (company.budgetExpiredDays <= 7 && company.budgetExpiredDays > 0) {
            this.setState({
              stateData: 3,
            })
            this.openBottomSheet()
          } else if (company.budgetPopUpType === 2 && company.budgetExpiredDays > 7) {
            this.setState({
              stateData: 2,
            })
            this.openBottomSheet()
      ...
      return (
        <View style={[{
            ...
            <Animated.View
              ...
              style={[{
                ...
                opacity: _deltaY.interpolate({
                  inputRange: [0, 1, Screen.height - (stateData === 3 ? 360 : (stateData === 4 ? 240 : 550)), Screen.height + 30],
          ...
          <Interactable.View
            ...
            snapPoints={[{ y: 20 }, { y: Screen.height - (stateData === 3 ? 360 : (stateData === 4 ? 240 : 550)) }, { y: Screen.height + 30 }]}
            boundaries={{ top: (stateData === 3 ? -360 : (stateData === 4 ? -240 : -550)) }}
                  ...
                  {(stateData === 1 || stateData === 2) && (<Fragment>
                    ...
                    <View style={{
                      ...
                      <Text style={[{
                        ...
                        {stateData === 1 ? 'ואתם נהנים ללא עלות נוספת!' : 'אנו מזמינים אתכם להתנסות של חודש חינם'}
                      </Text>
                      {stateData === 2 && (
                        <Text style={[{
                          fontSize: sp(16),
