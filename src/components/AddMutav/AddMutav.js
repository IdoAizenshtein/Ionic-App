...
import { Keyboard, Modal, SafeAreaView, Text, TextInput, TouchableOpacity, View } from 'react-native'
...
import styles from '../../screens/SettingsScreen/components/BaseTokenTab/components/AddTokenModal/AddTokenModalStyles'
...
export default class AddMutav extends PureComponent {
  constructor (props) {
    ...
    if (isEdit && this.props.companyId) {
      getAccountCflTransTypeApi.post({ body: { uuid: this.props.companyId } })
        .then(data => {
          ...
          const transTypeId = categories.find((item) => item.transTypeId === isEdit.transTypeId)
          this.setState({
            transTypeId,
          })
        })
    ...
    handleSelectCategory = (category) => {
      ...
      this.setState({ categoriesModalIsOpen: false, currentEditBankTrans: null, transTypeId: { ...newBankTrans } })
    };
    ...
    existingMutav = () => {
      ...
      if ((
        ...
        existingMutavApi.post({
          ...
          .then((res) => {
            if (res.length) {
              this.setState({ existingMutav: res[0], inProgress: false })
            } else {
              this.setState({ existingMutav: false, inProgress: false })
            }
          })
          .catch(() => {
    ...
    update = () => {
      ...
      if (this.progress || inProgress || !(
        !existingMutav &&
            (!mailIsHebrew) &&
            (contactPhoneValid && companyHpValid && contactMailValid && accountMutavNameValid && snifIdValid && accountIdValid && bankIdValid) &&
            ((bankId !== null) && String(accountMutavName).length > 0 && String(accountId).length > 0 && String(snifId).length > 0)
      )) {
        return
      }
      ...
      if ((
        ...
        this.progress = true
        this.setState({ inProgress: true, save: true })
        ...
        existingMutavApi.post({
          ...
          .then((res) => {
            if (res.length) {
              this.setState({ existingMutav: res[0], inProgress: false, save: false })
              this.progress = false
            } else {
              this.setState({ existingMutav: false, inProgress: false })
              ...
              if (isEdit) {
                ...
                updateMutavApi.post({
                  ...
                  .then(() => {
                    ...
                    //     this.setState({ inProgress: false })
                    //   })
                    this.setState({ inProgress: false, save: false })
                    this.progress = false
                    update()
                  })
                  .catch(() => {
        ...
        this.progress = true
        this.setState({ existingMutav: false, inProgress: true })
    ...
    handleChangeBankId = (bankId) => {
      this.setState({ bankId: bankId, existingMutav: false })
      const {
        accountId,
        snifId,
        inProgress,
    ...
    handleUpdateField = name => val => {
      ...
      } else if (name === 'accountMutavHp' || name === 'snifId' || name === 'accountId') {
        value = value.toString().replace(/[^\d]/g, '')
      }

      this.setState({ [name]: value, existingMutav: false })
                    ...
                    <View style={[cs(!isRtl, commonStyles.row, [commonStyles.rowReverse]), {
                      ...
                      <View style={[{
                        ...
                        <TextInput
                          ...
                          onEndEditing={this.handleUpdateFieldValid('accountMutavNameValid', false, !IS_IOS)}
                          onBlur={this.handleUpdateFieldValid('accountMutavNameValid', false, IS_IOS)}
                          onChangeText={this.handleUpdateField('accountMutavName')}
                    ...
                    <View style={[cs(!isRtl, commonStyles.row, [commonStyles.rowReverse]), {
                      ...
                      <View style={[{
                        ...
                        <TouchableOpacity
                          ...
                          onPress={!distableEdit ? this.handleToggleBankModal : null}>
                          <View style={{
                            marginRight: 'auto',
                          }}>
                    ...
                    <View
                      ...
                      <View style={[{
                        ...
                        <TextInput
                          ...
                          onEndEditing={this.handleUpdateFieldValid('snifIdValid', false, !IS_IOS)}
                          onBlur={this.handleUpdateFieldValid('snifIdValid', false, IS_IOS)}
                    ...
                    <View
                      ...
                      <View style={[{
                        ...
                        <TextInput
                          ...
                          onEndEditing={this.handleUpdateFieldValid('accountIdValid', false, !IS_IOS)}
                          onBlur={this.handleUpdateFieldValid('accountIdValid', false, IS_IOS)}
                    ...
                    <View style={[cs(!isRtl, commonStyles.row, [commonStyles.rowReverse]), {
                      ...
                      <View style={[{
                        ...
                        <TextInput
                          ...
                          onEndEditing={(e) => {
                            this.setState({ contactName: e.nativeEvent.text.toString().replace(getEmoji(), '') })
                          }}
                      ...
                      <View style={[{
                        ...
                        <TextInput
                          ...
                          style={[{
                            ...
                            height: 42,
                            fontSize: sp(15),
                            textAlign: (!contactMail || (contactMail && contactMail.length === 0)) ? 'right' : emailSide,
                            width: '100%',
                          }, commonStyles.regularFont]}
                          autoCorrect={false}
                          autoCapitalize='none'
                      ...
                      <View style={[{
                        ...
                        <TextInput
                          ...
                          style={[{
                            ...
                            height: 42,
                            fontSize: sp(15),
                            textAlign: (!contactPhone || (contactPhone && contactPhone.length === 0)) ? 'right' : billingAccountPhoneSide,
                            width: '100%',
                          }, commonStyles.regularFont]}
                          onEndEditing={(e) => {
                            this.setState({ contactPhone: e.nativeEvent.text.toString().replace(/[^\d-]/g, '') })
                      ...
                      <View style={[{
                        ...
                        <TextInput
                          ...
                          style={[{
                            ...
                            height: 42,
                            fontSize: sp(15),
                            textAlign: (!accountMutavHp || (accountMutavHp && String(accountMutavHp).length === 0)) ? 'right' : companyIdSide,
                            width: '100%',
                          }, commonStyles.regularFont]}
                          onEndEditing={(e) => {
                            this.setState({ accountMutavHp: e.nativeEvent.text.toString().replace(/[^\d]/g, '') })
