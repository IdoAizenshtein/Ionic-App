...
export default class CalendarSlider extends PureComponent {
  ...
  componentWillReceiveProps (props) {
    ...
    if (props && props.isOpen === false && props.isOpen !== this.props.isOpen) {
    ...
    return (
      <View style={[styles.panelContainer]} pointerEvents={'box-none'}>
        ...
        <Interactable.View
          ...
          snapPoints={[{ y: 40 }, { y: Screen.height - 500 }, { y: Screen.height + 30 }]}
          boundaries={{ top: -500 }}
            ...
            <View style={{ left: 0, right: 0, height: Screen.height - 90 }}>
              <View
                ...
                <Text style={{
                  ...
                  fontFamily: fonts.regular,
                  textAlign: 'center',
                }}>{'סינון לפי תאריך '}{isOpen === 'SendDate' ? 'שליחה' : 'מסמך'}</Text>
                ...
                renderHeader={(date) => {
                  ...
                  return (
                    <View style={{
                      ...
                      <Text style={{ fontSize: sp(31), ...textStyle }}>{`${month}`}</Text>
                      <Text style={{ fontSize: sp(12), ...textStyle }}>{year}</Text>
                    </View>
                  )
                }}
