...
export class AccountAlertOverview extends PureComponent {
  ...
  constructor (props) {
    ...
    if (!IS_LIGHT.light && props.selectedAccounts && props.selectedAccounts.length === 1 && props.selectedAccounts[0] && props.selectedAccounts[0].companyId && props.selectedAccounts[0].nonUpdateDays > 0 && props.selectedAccounts[0].alertStatus === null) {
    ...
    if ([
      ...
      return (
        <View style={{
          ...
          <View
            style={{ width: 200, height: 6, backgroundColor: 'powderblue', marginTop: 10, marginBottom: 5 }}>
      ...
      return (
        <TouchableOpacity
          ...
          <Text style={{
            ...
            {'עדכון אחרון לפני'} {AppTimezone.moment().diff(selectedAccounts[0].balanceLastUpdatedDate, 'days')} {'ימים'}
          </Text>
          {(hasBtnUpdate) && (
            <View style={{
              alignItems: 'center',
    ...
    if (IS_LIGHT.light) {
      return (
        <View>
          ...
          {!isSelectedNotUpdatedAccounts && accountExceptionExpected && (<Fragment>
            <Text style={{
              color: '#ef3636',
              fontFamily: fonts.bold,
              fontSize: sp(21),
          ...
          {accountNicknameAccountException && (<Fragment>
            <Text style={{
              ...
              {'חשבון'} {(accountNicknameAccountException) ? selectedDeviantAccounts[0].accountNickname : ''} ({getCurrencyChar(selectedDeviantAccounts[0].currency)}) {'בחריגה'}
            </Text>
          </Fragment>)}
          ...
          {!isSelectedNotUpdatedAccounts && !accountNicknameAccountException && !xAccountsExceeded && !accountExceptionExpected && (
            <Fragment>
              <Text style={{
                color: '#229f88',
                fontFamily: fonts.bold,
          ...
          if (alertStatus === 'Not found in bank website') {
            return (
              <View style={{
                ...
                <Image style={{ width: 17, height: 19 }}
                  resizeMode='contain'
          ...
          return (
            <View>
              ...
              <Text style={{
                ...
                {'צפויה חריגה מתאריך'} {AppTimezone.moment(expectedDateExceededAcc[0].harigaDate).format('DD/MM/YY')}
              </Text>
            </View>
          )
        }
          ...
          return (<View>
            <TouchableOpacity
              ...
              <Text style={{
                ...
                {'חשבון'} {(accountNicknameAccountException) ? selectedDeviantAccounts[0].accountNickname : ''} {'בחריגה'}
              </Text>
            ...
            <View>
              <TouchableOpacity
                ...
                <Text style={{
                  ...
                  {'צפויה חריגה ל-'} {(expectedDateExceededAcc) ? expectedDateExceededAcc.length : ''} {'חשבונות'}
                </Text>
              </TouchableOpacity>
            </View>
          )
              ...
              <TouchableOpacity
                ...
                <View style={{
                  ...
                  <Text style={{
                    ...
                    {'ב'}{accounts ? accounts.find(d => d.companyAccountId === expectedDateExceededAcc[0].accountUuid).accountNickname : ''} {'מ-'} {AppTimezone.moment(expectedDateExceededAcc[0].harigaDate).format('DD/MM/YY')}
                  </Text>
                </View>
                <View style={{
                  alignItems: 'flex-end',
                  ...
                  <Icon name='chevron-left' size={28} color={colors.blue32} />
                </View>
              </TouchableOpacity>
            </View>
          )
  ...
  componentWillReceiveProps (nextProps) {
    ...
    if (!IS_LIGHT.light && selectedAccounts && selectedAccountsNextProps.length === 1 && selectedAccountsNextProps[0] && selectedAccountsNextProps[0].companyId && (selectedAccounts[0].companyAccountId !== selectedAccountsNextProps[0].companyAccountId)) {
  ...
  startPullingTokenStatus = () => {
    this.intervalId = setInterval(() => {
      const { selectedAccounts } = this.props
      if (!IS_LIGHT.light && selectedAccounts && selectedAccounts.length && selectedAccounts[0].companyId) {
